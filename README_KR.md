...
해당 프로그램에서는 펌웨어 업그레이드가 **불가능**합니다. 

제품의 펌웨어를 업그레이드하기 위해서는 퀄컴의 독자적인 라이브러리가 필요하나, 해당 라이브러리는 모두에게 공개되어 있지 않을 뿐더러, 윈도우를 제외한 다른 OS에서는 사용할 수 없습니다. 펌웨어를 업그레이드하시려면 공식 윈도우 FlooCast 소프트웨어를 사용해주세요.
